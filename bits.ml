(* From: https://github.com/plum-umd/adapton.ocaml/blob/master/src/core/bits.ml *)
(* See also: https://github.com/plum-umd/adapton.ocaml/commit/6bab504976a8a4cc0025d8df2641a2774776bfd9 *)
(*      and: http://en.wikipedia.org/wiki/Find_first_set *)
let ffs0 =
