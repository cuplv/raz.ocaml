...
test.native: test.ml raz_simp.ml raz_2.ml fingertree.ml batEnum.ml batInnerIO.ml batInnerWeaktbl.ml batConcurrent.ml batRef.ml batOrd.ml batInterfaces.ml batList.ml batMap.ml batPrintf.ml batBuffer.ml batString.ml batReturn.ml batChar.ml batInt.ml batNumber.ml
	$(OCB) test.native
